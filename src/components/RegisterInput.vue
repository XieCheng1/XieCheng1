...
<template>
    <div class="box">
        ...
        <div class="centerBox">
            <li class="oneLi">
                <input type="button" value="中国大陆 86">
            </li>
            <li class="twoLi">
                <input placeholder="常用手机号" v-model="msg">
            </li>
            <el-button :plain="true" @click="hint() ">下一步，验证手机号</el-button>
...
export default {
    ...
    methods:{
       ...
       open4() {
        this.$message.error('请输入13，15，18，开头的正确手机号');
      },
      hint:function(){
        var flagTel=false;
        var regName=/^1(3|5|8)\d{9}$/;
          if(this.msg == ""){
              this.open3();
